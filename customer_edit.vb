...
Public Class customer_edit
    ...
    Dim database As String = "grocery"
    ...
    Private Sub updateTable()
        ...
        sqlCmd.CommandText = "SELECT * FROM grocery.customer"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            sqlConn.Open()
            sqlQuery = "Delete from grocery.customer where name = '" & TextBox1.Text & "'"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            sqlConn.Open()
            sqlQuery = "Insert into grocery.customer(name, phone, DOB, country, State, pincode, address) values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & DateTimePicker1.Text & "','" & TextBox4.Text & "','" & TextBox5.Text & "','" & TextBox6.Text & "','" & TextBox7.Text & "')"
            sqlCmd = New MySqlCommand(sqlQuery, sqlConn)
            sqlRd = sqlCmd.ExecuteReader
            sqlConn.Close()
        Catch ex As Exception
