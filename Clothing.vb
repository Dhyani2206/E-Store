...
Public Class Clothing
    ...
    Private Sub Clothing_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        "server = localhost; userid = root; password = Shambhoo@2206; database = grocery"
        ...
        Try
            ...
            Query = "select * from grocery1.stock where category = 'Tshirt'"
            ...
            Query1 = "select * from grocery1.stock where category = 'Jeans'"
            ...
            Query2 = "select * from grocery1.stock where category = 'Shoes'"
