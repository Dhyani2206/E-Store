...
Public Class stock_edit
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            sqlConn.Open()
            sqlQuery = "insert into grocery1.stock(description, quantity, Category, Price, DOF) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + DateTimePicker1.Text + "')"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Try
            sqlConn.Open()
            sqlQuery = "Delete from grocery1.stock where name = '" & TextBox1.Text & "'"
            sqlCmd = New MySqlCommand(sqlQuery, sqlConn)
            sqlRd = sqlCmd.ExecuteReader
